...
def generate_prompt(age_group, job, household, region):
    ...
    카드뉴스 구성:
    1. 주의를 끄는 제목 (15단어 이내)
    2. 도입부: 고객의 상황이나 니즈에 공감하는 1-2문장 (25단어 이내)
    3. 핵심 내용: 
       - 이 고객에게 적합한 보험 상품이나 서비스 소개 (1-2개 항목, 각 16단어 이내)
       - 각 항목의 주요 혜택이나 특징 (각 15단어 이내)
    4. 고객에게 제공하는 가치나 해결할 수 있는 문제 설명 (20단어 이내)
    5. 행동 유도 문구(CTA): 다음 단계를 안내하는 문장 (15단어 이내)

    전체 카드뉴스 내용은 150단어를 넘지 않도록 해주세요. 
    보험사이지만 보험 권유, 보험 아이템 소개 두 가지는 반드시 지양해주시고 고객의 잠재 리스크에 대해 제시문으로 안내하여 고객이 신기함에 전화해보게 유도해주세요.

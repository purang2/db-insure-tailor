...
def generate_prompt(age_group, job, household, region, scenario):
    ...
    **고객 프로필:**
    ...
    카드뉴스 구성:
    1. 신뢰할 수 있는 통계와 공감 메시지 결합 (15단어 이내)
    2. {scenario}에 대한 실용적 팁과 {region} 특성을 반영한 정보 제공 (20단어 이내)
    3. 고객 프로필에 맞춘 맞춤형 조언 또는 미니 스토리텔링 (15단어 이내)
    4. 안전과 대비의 중요성을 강조하는 메시지와 다양한 대응 방안 (15단어 이내)
    5. AI 생성 콘텐츠 명시 및 개인정보 보호 관련 안내 (10단어 이내)

    전체 내용은 80단어 이내로, 선택된 시나리오를 중심으로 고객 프로필에 맞춰 균형 잡힌 정보를 제공해주세요. {age_specific_prompt}
    """

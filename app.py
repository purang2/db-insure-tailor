...
age_prompts = {
    ...
    작성 시 다음 사항을 고려해주세요:
    1. 흥미로운 통계 데이터로 시작하여 관심을 끌어주세요. (예: "20대의 67%가 재테크에 관심 있다는 사실, 알고 계셨나요?")
    2. 20대의 고민과 열정에 깊이 공감하는 따뜻한 톤을 유지하세요.
    3. 실용적이고 유용한 정보나 팁을 간결하게 제공하세요.
    4. 밝고 희망적인 미래를 그리되, 현실적인 조언을 함께 담아주세요.
    5. 보험의 필요성을 직접적으로 언급하기보다, 삶의 안전망으로서 은유적으로 표현하세요.
    
    카드뉴스 구성:
    1. 흥미로운 통계로 시작하는 주의 끌기 (10단어 이내)
    2. 20대의 상황에 공감하는 따뜻한 메시지 (10단어 이내)
    3. 실용적인 팁이나 조언 제공 (10단어 이내)
    4. 희망적 미래와 함께하는 든든한 지원 약속 (10단어 이내)
    5. 다음 단계를 위한 간결한 행동 유도 문구 (5단어 이내)

...
age_prompts = {
    "20대": """
    당신은 ABC손해보험의 광고 카피라이팅 전문가입니다. 마음을 울리는 스토리텔링 카피라이팅을 지향해야 합니다. 20대를 위한 보험 관련 문자 메시지 카드뉴스를 작성해주세요.

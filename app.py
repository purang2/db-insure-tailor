...
def generate_prompt(age_group, job, household, region, scenario):
    ...
    카드뉴스 구성:
    1. 주의를 끄는 제목 (13단어 이내)
    2. 도입부: 특정 시나리오와 고객의 상황에 공감하는 1문장 (15단어 이내)
    3. 핵심 내용: 
       - 이 시나리오와 고객에게 적합한 보험 상품이나 서비스 소개 (1개 항목, 각 11단어 이내)
       - 각 항목의 주요 혜택이나 특징 (각 11단어 이내)
    4. 이 시나리오에서 고객에게 제공하는 가치나 해결할 수 있는 문제 설명 (15단어 이내)
    5. 행동 유도 문구(CTA): 다음 단계를 안내하는 문장 (11단어 이내)
...
age_prompts = {
    "20대": """
    당신은 ABC손해보험의 UX 라이팅 전문가입니다. 20대를 위한 보험 관련 문자 메시지 카드뉴스를 작성해주세요.
    ...
    카드뉴스 구성:
    1. 주의를 끄는 제목 (15단어 이내)
    2. 도입부: 20대의 상황에 공감하는 1-2문장 (25단어 이내)
    3. 핵심 내용: 
       - 이 연령대에 적합한 보험 상품이나 서비스 소개 (1-2개 항목, 각 16단어 이내)
       - 각 항목의 주요 혜택이나 특징 (각 15단어 이내)
    4. 20대에게 제공하는 가치나 해결할 수 있는 문제 설명 (20단어 이내)
    5. 행동 유도 문구(CTA): 다음 단계를 안내하는 문장 (15단어 이내)

    전체 카드뉴스 내용은 120단어를 넘지 않도록 해주세요.
    """,

    "30대": """
    당신은 ABC손해보험의 UX 라이팅 전문가입니다. 30대를 위한 보험 관련 문자 메시지 카드뉴스를 작성해주세요.
    ...
    카드뉴스 구성:
    1. 주의를 끄는 제목 (15단어 이내)
    2. 도입부: 30대의 상황에 공감하는 1-2문장 (25단어 이내)
    3. 핵심 내용: 
       - 이 연령대에 적합한 보험 상품이나 서비스 소개 (1-2개 항목, 각 16단어 이내)
       - 각 항목의 주요 혜택이나 특징 (각 15단어 이내)
    4. 30대에게 제공하는 가치나 해결할 수 있는 문제 설명 (20단어 이내)
    5. 행동 유도 문구(CTA): 다음 단계를 안내하는 문장 (15단어 이내)
    ...
    "40대": """
    당신은 ABC손해보험의 UX 라이팅 전문가입니다. 40대를 위한 보험 관련 문자 메시지 카드뉴스를 작성해주세요.
    ...
    카드뉴스 구성:
    1. 주의를 끄는 제목 (15단어 이내)
    2. 도입부: 40대의 상황에 공감하는 1-2문장 (25단어 이내)
    3. 핵심 내용: 
       - 이 연령대에 적합한 보험 상품이나 서비스 소개 (1-2개 항목, 각 16단어 이내)
       - 각 항목의 주요 혜택이나 특징 (각 15단어 이내)
    4. 40대에게 제공하는 가치나 해결할 수 있는 문제 설명 (20단어 이내)
    5. 행동 유도 문구(CTA): 다음 단계를 안내하는 문장 (15단어 이내)
    ...
    "50대": """
    당신은 ABC손해보험의 UX 라이팅 전문가입니다. 50대를 위한 보험 관련 문자 메시지 카드뉴스를 작성해주세요.
    ...
    카드뉴스 구성:
    1. 주의를 끄는 제목 (15단어 이내)
    2. 도입부: 50대의 상황에 공감하는 1-2문장 (25단어 이내)
    3. 핵심 내용: 
       - 이 연령대에 적합한 보험 상품이나 서비스 소개 (1-2개 항목, 각 16단어 이내)
       - 각 항목의 주요 혜택이나 특징 (각 15단어 이내)
    4. 50대에게 제공하는 가치나 해결할 수 있는 문제 설명 (20단어 이내)
    5. 행동 유도 문구(CTA): 다음 단계를 안내하는 문장 (15단어 이내)
    ...
    "60대 이상": """
    당신은 ABC손해보험의 UX 라이팅 전문가입니다. 60대 이상을 위한 보험 관련 문자 메시지 카드뉴스를 작성해주세요.
    ...
    카드뉴스 구성:
    1. 주의를 끄는 제목 (15단어 이내)
    2. 도입부: 60대 이상의 상황에 공감하는 1-2문장 (25단어 이내)
    3. 핵심 내용: 
       - 이 연령대에 적합한 보험 상품이나 서비스 소개 (1-2개 항목, 각 16단어 이내)
       - 각 항목의 주요 혜택이나 특징 (각 15단어 이내)
    4. 60대 이상에게 제공하는 가치나 해결할 수 있는 문제 설명 (20단어 이내)
    5. 행동 유도 문구(CTA): 다음 단계를 안내하는 문장 (15단어 이내)

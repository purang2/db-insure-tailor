...
age_prompts = {
    ...
    3. 핵심 내용: 
       - 이 연령대에 적합한 보험 상품이나 서비스 소개 (1개 항목, 각 14단어 이내)
       - 각 항목의 주요 혜택이나 특징 (각 11단어 이내)
    ...
    3. 핵심 내용: 
       - 이 연령대에 적합한 보험 상품이나 서비스 소개 (1개 항목, 각 12단어 이내)
       - 각 항목의 주요 혜택이나 특징 (각 11단어 이내)
    ...
    4. 40대에게 제공하는 가치나 해결할 수 있는 문제 설명 (15단어 이내)
    5. 행동 유도 문구(CTA): 다음 단계를 안내하는 문장 (11단어 이내)
    ...
    3. 핵심 내용: 
       - 이 연령대에 적합한 보험 상품이나 서비스 소개 (1개 항목, 각 12단어 이내)
       - 각 항목의 주요 혜택이나 특징 (각 12단어 이내)
    4. 50대에게 제공하는 가치나 해결할 수 있는 문제 설명 (15단어 이내)
    5. 행동 유도 문구(CTA): 다음 단계를 안내하는 문장 (11단어 이내)
    ...
    3. 핵심 내용: 
       - 이 연령대에 적합한 보험 상품이나 서비스 소개 (1개 항목, 각 12단어 이내)
       - 각 항목의 주요 혜택이나 특징 (각 12단어 이내)
    4. 60대 이상에게 제공하는 가치나 해결할 수 있는 문제 설명 (15단어 이내)
    5. 행동 유도 문구(CTA): 다음 단계를 안내하는 문장 (11단어 이내)

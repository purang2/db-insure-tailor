...
def generate_prompt(age_group, job, household, region, scenario):
    ...
    카드뉴스 구성:
    1. 시나리오와 적합한 흥미로운 통계, 사실, 수칙, 노하우 등으로 시작하는 주의 끌기 (10단어 이내)
    2. 고객의 상황에 공감하는 따뜻한 메시지 (10단어 이내)
    3. 실용적인 팁이나 조언 제공 (=보험권유 절대금지)(10단어 이내)
    4. 희망적 미래와 함께하는 든든한 지원 약속 (=보험권유 절대금지) (10단어 이내)
